...
const TRANSLATIONS = {
  en: {
    ...
    'v2.fleet.title': 'Tesla Fleet Compatibility',
    'v2.fleet.subtitle': 'Connect with a Tesla Fleet API access token to verify if your vehicle is ready.',
    'v2.fleet.tokenPlaceholder': 'Tesla Fleet access token',
    'v2.fleet.baseUrlPlaceholder': 'Fleet API base URL (optional)',
    'v2.fleet.connect': 'Connect Tesla',
    'v2.fleet.check': 'Check Compatibility',
    'v2.fleet.tutorialCta': 'Open Fleet Tutorial',
    'v2.fleet.notConnected': 'Not connected',
    'v2.fleet.enterToken': 'Please enter a Tesla Fleet access token.',
    'v2.fleet.connecting': 'Connecting to Tesla Fleet API...',
    'v2.fleet.noVehicles': 'Connected, but no vehicles were returned for this account.',
    'v2.fleet.connectedCount': 'Connected: {count} vehicle(s) loaded.',
    'v2.fleet.connectionFailed': 'Connection failed: {error}',
    'v2.fleet.noVehiclesOption': 'No vehicles',
    'v2.fleet.selectVehicle': 'Select a vehicle first.',
    'v2.fleet.vehicleUnavailable': 'Selected vehicle is not available.',
    'v2.fleet.checking': 'Checking compatibility...',
    'v2.fleet.compatible': 'Compatible: {name} is likely ready for custom lock chimes.{notes}',
    'v2.fleet.needsAttention': 'Needs attention: {name} may need additional checks.{notes}',
    'v2.fleet.checkFailed': 'Compatibility check failed: {error}',
    'v2.fleet.notesPrefix': 'Notes',
    'v2.release.title': 'Release Update Watcher',
    'v2.release.subtitle': 'Detect new release notes and get sound recommendations instantly.',
    'v2.release.check': 'Check Release Notes',
    'v2.release.noChecks': 'No release checks yet',
    'v2.release.connectFirst': 'Connect Tesla and select a vehicle first.',
    'v2.release.noVersion': 'No release version found in response.',
    'v2.release.updated': 'Update detected: {previous} -> {current}',
    'v2.release.noUpdate': 'No new update detected. Current version: {current}',
    'v2.release.failed': 'Release check failed: {error}',
    ...
    // Fleet Tutorial
    'tutorial.backToApp': 'Back to App',
    'tutorial.kicker': 'Tesla Fleet API Guide',
    'tutorial.title': 'Connect Tesla Fleet in 10 Minutes',
    'tutorial.subtitle': 'Follow this checklist to generate an access token, connect your vehicle, and verify lock chime compatibility safely.',
    'tutorial.metaTime': 'Estimated time: 10-15 min',
    'tutorial.metaNeed': 'Need: Tesla account + browser',
    'tutorial.stepsTitle': 'Step-by-Step',
    'tutorial.step1Title': 'Open Tesla Developer Portal',
    'tutorial.step1Desc': 'Go to developer.tesla.com, sign in with your Tesla account, then open Fleet API settings.',
    'tutorial.step2Title': 'Create an OAuth App',
    'tutorial.step2Desc': 'Set app name, allowed redirect URI, and generate client credentials for personal use.',
    'tutorial.step3Title': 'Request Vehicle Scopes',
    'tutorial.step3Desc': 'Enable required scopes like vehicle_device_data and vehicle_cmds. Start with minimum scope.',
    'tutorial.step4Title': 'Issue Access Token',
    'tutorial.step4Desc': 'Run your OAuth flow and copy the access token. Keep it private and do not upload it to Git.',
    'tutorial.step5Title': 'Paste Token in App',
    'tutorial.step5Desc': 'In Tesla Lock Sound Creator, paste token into Tesla Fleet access token input and click Connect Tesla.',
    'tutorial.step6Title': 'Select Vehicle and Check',
    'tutorial.step6Desc': 'Choose your vehicle from the list and click Check Compatibility to validate readiness.',
    'tutorial.step7Title': 'Rotate Token Regularly',
    'tutorial.step7Desc': 'Revoke old tokens and rotate credentials periodically for account safety.',
    'tutorial.securityTitle': 'Security Checklist',
    'tutorial.sec1': 'Never share access tokens in screenshots or support chats.',
    'tutorial.sec2': 'Store tokens in secure vaults, not plain text files.',
    'tutorial.sec3': 'Use shortest practical token expiration.',
    'tutorial.sec4': 'Immediately revoke token if leakage is suspected.',
    'tutorial.troubleshootTitle': 'Troubleshooting',
    'tutorial.error401Title': '401 Unauthorized:',
    'tutorial.error401Desc': 'Token expired or invalid. Regenerate token and reconnect.',
    'tutorial.error403Title': '403 Forbidden:',
    'tutorial.error403Desc': 'Scope is insufficient. Reconfigure OAuth scopes in Tesla Developer portal.',
    'tutorial.errorNoVehicleTitle': 'No vehicles returned:',
    'tutorial.errorNoVehicleDesc': 'Check if account has an active vehicle and correct region/base URL.',
  },
  ...
  ko: {
    ...
    'v2.fleet.title': 'Tesla Fleet 호환성',
    'v2.fleet.subtitle': 'Tesla Fleet API 액세스 토큰을 연결해 차량 준비 상태를 확인하세요.',
    'v2.fleet.tokenPlaceholder': 'Tesla Fleet 액세스 토큰',
    'v2.fleet.baseUrlPlaceholder': 'Fleet API 기본 URL (선택)',
    'v2.fleet.connect': 'Tesla 연결',
    'v2.fleet.check': '호환성 확인',
    'v2.fleet.tutorialCta': 'Fleet 튜토리얼 열기',
    'v2.fleet.notConnected': '연결되지 않음',
    'v2.fleet.enterToken': 'Tesla Fleet 액세스 토큰을 입력해주세요.',
    'v2.fleet.connecting': 'Tesla Fleet API에 연결 중...',
    'v2.fleet.noVehicles': '연결되었지만 이 계정에는 차량 정보가 없습니다.',
    'v2.fleet.connectedCount': '연결됨: 차량 {count}대 로드 완료.',
    'v2.fleet.connectionFailed': '연결 실패: {error}',
    'v2.fleet.noVehiclesOption': '차량 없음',
    'v2.fleet.selectVehicle': '먼저 차량을 선택해주세요.',
    'v2.fleet.vehicleUnavailable': '선택한 차량 정보를 사용할 수 없습니다.',
    'v2.fleet.checking': '호환성 확인 중...',
    'v2.fleet.compatible': '호환 가능: {name} 차량은 커스텀 잠금음 사용 준비가 된 것으로 보입니다.{notes}',
    'v2.fleet.needsAttention': '확인 필요: {name} 차량은 추가 점검이 필요할 수 있습니다.{notes}',
    'v2.fleet.checkFailed': '호환성 확인 실패: {error}',
    'v2.fleet.notesPrefix': '참고',
    'v2.release.title': '릴리즈 업데이트 감시',
    'v2.release.subtitle': '새 릴리즈 노트를 감지하고 사운드 추천을 바로 확인하세요.',
    'v2.release.check': '릴리즈 노트 확인',
    'v2.release.noChecks': '아직 릴리즈 확인 기록이 없습니다',
    'v2.release.connectFirst': 'Tesla를 연결하고 차량을 먼저 선택해주세요.',
    'v2.release.noVersion': '응답에서 릴리즈 버전을 찾을 수 없습니다.',
    'v2.release.updated': '업데이트 감지: {previous} -> {current}',
    'v2.release.noUpdate': '새 업데이트 없음. 현재 버전: {current}',
    'v2.release.failed': '릴리즈 확인 실패: {error}',
    ...
    // Fleet Tutorial
    'tutorial.backToApp': '앱으로 돌아가기',
    'tutorial.kicker': 'Tesla Fleet API 가이드',
    'tutorial.title': '10분 안에 Tesla Fleet 연결하기',
    'tutorial.subtitle': '이 체크리스트대로 진행하면 액세스 토큰 생성, 차량 연결, 락차임 호환성 확인까지 안전하게 완료할 수 있습니다.',
    'tutorial.metaTime': '예상 소요 시간: 10-15분',
    'tutorial.metaNeed': '준비물: Tesla 계정 + 브라우저',
    'tutorial.stepsTitle': '단계별 안내',
    'tutorial.step1Title': 'Tesla 개발자 포털 접속',
    'tutorial.step1Desc': 'developer.tesla.com에 접속해 Tesla 계정으로 로그인한 뒤 Fleet API 설정으로 이동하세요.',
    'tutorial.step2Title': 'OAuth 앱 생성',
    'tutorial.step2Desc': '앱 이름과 Redirect URI를 설정하고 개인 사용 목적의 클라이언트 자격 정보를 생성하세요.',
    'tutorial.step3Title': '차량 권한 범위 요청',
    'tutorial.step3Desc': 'vehicle_device_data, vehicle_cmds 같은 필요한 scope를 활성화하고 최소 권한부터 시작하세요.',
    'tutorial.step4Title': '액세스 토큰 발급',
    'tutorial.step4Desc': 'OAuth 플로우를 실행해 액세스 토큰을 발급받으세요. 토큰은 비공개로 관리하고 Git에 올리지 마세요.',
    'tutorial.step5Title': '앱에 토큰 입력',
    'tutorial.step5Desc': 'Tesla Lock Sound Creator의 Tesla Fleet access token 입력란에 토큰을 붙여 넣고 Tesla 연결 버튼을 누르세요.',
    'tutorial.step6Title': '차량 선택 후 검사',
    'tutorial.step6Desc': '목록에서 차량을 선택한 뒤 호환성 확인 버튼을 눌러 준비 상태를 검증하세요.',
    'tutorial.step7Title': '토큰 정기 교체',
    'tutorial.step7Desc': '오래된 토큰은 폐기하고 자격 정보를 주기적으로 교체해 계정 보안을 유지하세요.',
    'tutorial.securityTitle': '보안 체크리스트',
    'tutorial.sec1': '스크린샷이나 지원 채팅에 액세스 토큰을 절대 공유하지 마세요.',
    'tutorial.sec2': '토큰은 평문 파일이 아닌 안전한 보관소에 저장하세요.',
    'tutorial.sec3': '가능한 한 짧은 만료 시간의 토큰을 사용하세요.',
    'tutorial.sec4': '유출이 의심되면 즉시 토큰을 폐기하세요.',
    'tutorial.troubleshootTitle': '문제 해결',
    'tutorial.error401Title': '401 Unauthorized:',
    'tutorial.error401Desc': '토큰이 만료되었거나 유효하지 않습니다. 토큰을 재발급하고 다시 연결하세요.',
    'tutorial.error403Title': '403 Forbidden:',
    'tutorial.error403Desc': '권한 범위가 부족합니다. Tesla 개발자 포털에서 OAuth scope를 다시 설정하세요.',
    'tutorial.errorNoVehicleTitle': '차량 목록이 없음:',
    'tutorial.errorNoVehicleDesc': '계정에 활성 차량이 있는지, 지역/기본 URL이 올바른지 확인하세요.',
  },
