...
const TRANSLATIONS = {
  en: {
    ...
    // Dashboard
    'dash.back': '← Back',
    'dash.title': 'My Tesla Dashboard',
    'dash.auth.signedOut': 'Not signed in',
    'dash.auth.login': 'Login',
    'dash.auth.google': 'Google',
    'dash.auth.kakao': 'Kakao',
    'dash.auth.naver': 'Naver',
    'dash.auth.logout': 'Logout',
    'dash.customize': 'Customize',
    'dash.subtitle': 'Pick a Tesla display size and build your own widget layout.',
    'dash.vehicleModel': 'Tesla Model / Display',
    'dash.model.model3': 'Model 3',
    'dash.model.modely': 'Model Y',
    'dash.model.models': 'Model S',
    'dash.model.modelx': 'Model X',
    'dash.model.cybertruck': 'Cybertruck',
    'dash.display.default': 'Display: 1920 x 1200',
    'dash.display.format': 'Display: {width} x {height} ({model})',
    'dash.backgroundTheme': 'Background Theme',
    'dash.theme.teslaRed': 'Tesla Red',
    'dash.theme.midnight': 'Midnight Asphalt',
    'dash.theme.sunrise': 'Sunrise Drive',
    'dash.theme.emerald': 'Emerald Circuit',
    'dash.backgroundUrl': 'Custom Background URL (optional)',
    'dash.backgroundUrlPlaceholder': 'https://...',
    'dash.widgets': 'Widgets',
    'dash.widgetsSubtitle': 'Mix and match as many widgets as you want for your own layout.',
    'dash.widget.preview': 'Preview',
    'dash.widget.add': 'Add',
    'dash.widget.edit': 'Edit',
    'dash.widget.inspect': 'Inspect',
    'dash.widget.noSpace': 'No space left in this grid. Move or remove another widget.',
    'dash.widget.noSpaceForSize': 'Not enough space for this size.',
    'dash.widgetSearchPlaceholder': 'Search widget name...',
    'dash.filter.allCategories': 'All categories',
    'dash.filter.allStyles': 'All styles',
    'dash.previewHelp': 'Preview area: drag cards to move, drag bottom-right handle to resize.',
    'dash.resetLayout': 'Reset Grid Layout',
    'dash.preview': 'Preview',
    'dash.save': 'Save Dashboard',
    'dash.saveCopy': 'Save As My Copy',
    'dash.publicId': 'Public ID',
    'dash.copyShareLink': 'Copy Share Link',
    'dash.openByEmailOrId': 'Open by Email or ID',
    'dash.ownerPlaceholder': 'owner email or dash-xxxx',
    'dash.openDashboard': 'Open Dashboard',
    'dash.urlAccess': 'URL access:',
    'dash.widgets.noMatch': 'No widgets match this filter.',
    'dash.widgets.emptyTitle': 'Empty',
    'dash.widgets.emptyBadge': 'Info',
    'dash.widgets.emptyMain': 'No widgets selected',
    'dash.widgets.emptySub': 'Enable widgets from the left panel.',
    'dash.widget.resize': 'Resize',
    'dash.widget.badgeLive': 'Live',
    'dash.widget.defaultTitle': 'Widget',
    'dash.widget.defaultMain': 'Ready',
    'dash.widget.defaultSub': 'Configure from left panel',
    'dash.ownerFallback': 'Tesla owner',
    'dash.toast.loginFailed': 'Login failed. Check OAuth provider setup.',
    'dash.toast.loginRequired': 'Login required to save dashboard.',
    'dash.toast.saved': 'Dashboard saved.',
    'dash.toast.savedCopy': 'Copied and saved to your account.',
    'dash.toast.saveFirst': 'Save once to generate public ID.',
    'dash.toast.shareCopied': 'Share link copied.',
    'dash.toast.layoutInvalid': 'Layout has overlapping or out-of-bound widgets.',
    'dash.externalWidgets': 'External Widgets',
    'dash.externalWidgetsSubtitle': 'Add your own widget manifests by URL.',
    'dash.externalWidgetPlaceholder': 'https://example.com/widget-manifest.json',
    'dash.addExternalWidget': 'Add External Widget',
    'dash.toast.externalAdded': 'External widget registered.',
    'dash.toast.externalFailed': 'Failed to add external widget.',
    'dash.toast.externalDisabled': 'External widgets are temporarily disabled.',
    'dash.inspector': 'Widget Inspector',
    'dash.inspectorEmpty': 'Select a widget from preview or catalog to configure it.',
    'dash.inspectorWidget': 'Widget',
    'dash.sizeVariant': 'Size',
    'dash.size.small': 'Small',
    'dash.size.medium': 'Medium',
    'dash.size.large': 'Large',
    'dash.customTitle': 'Title',
    'dash.customTitlePlaceholder': 'Custom title (optional)',
    'dash.weather.locationMode': 'Weather location',
    'dash.weather.locationAuto': 'Use my current location',
    'dash.weather.locationManual': 'Choose a location',
    'dash.weather.searchPlaceholder': 'Search city...',
    'dash.weather.searchHint': 'Search and select a city.',
    'dash.weather.noResults': 'No locations found.',
    'dash.distanceUnit': 'Distance Unit',
    'dash.tempUnit': 'Temperature Unit',
    'dash.timeFormat': 'Clock Format',
  ...
  ko: {
    ...
    // Dashboard
    'dash.back': '← 뒤로',
    'dash.title': '내 Tesla 대시보드',
    'dash.auth.signedOut': '로그인되지 않음',
    'dash.auth.login': '로그인',
    'dash.auth.google': 'Google',
    'dash.auth.kakao': 'Kakao',
    'dash.auth.naver': 'Naver',
    'dash.auth.logout': '로그아웃',
    'dash.customize': '커스터마이즈',
    'dash.subtitle': 'Tesla 디스플레이 크기를 선택하고 나만의 위젯 레이아웃을 구성하세요.',
    'dash.vehicleModel': 'Tesla 모델 / 디스플레이',
    'dash.model.model3': 'Model 3',
    'dash.model.modely': 'Model Y',
    'dash.model.models': 'Model S',
    'dash.model.modelx': 'Model X',
    'dash.model.cybertruck': 'Cybertruck',
    'dash.display.default': '디스플레이: 1920 x 1200',
    'dash.display.format': '디스플레이: {width} x {height} ({model})',
    'dash.backgroundTheme': '배경 테마',
    'dash.theme.teslaRed': 'Tesla Red',
    'dash.theme.midnight': 'Midnight Asphalt',
    'dash.theme.sunrise': 'Sunrise Drive',
    'dash.theme.emerald': 'Emerald Circuit',
    'dash.backgroundUrl': '커스텀 배경 URL (선택)',
    'dash.backgroundUrlPlaceholder': 'https://...',
    'dash.widgets': '위젯',
    'dash.widgetsSubtitle': '원하는 위젯을 자유롭게 조합해 레이아웃을 만들어보세요.',
    'dash.widget.preview': '미리보기',
    'dash.widget.add': '추가',
    'dash.widget.edit': '편집',
    'dash.widget.inspect': '보기',
    'dash.widget.noSpace': '그리드에 빈 공간이 없습니다. 다른 위젯을 이동하거나 제거하세요.',
    'dash.widget.noSpaceForSize': '이 크기를 배치할 공간이 부족합니다.',
    'dash.widgetSearchPlaceholder': '위젯 이름 검색...',
    'dash.filter.allCategories': '전체 카테고리',
    'dash.filter.allStyles': '전체 스타일',
    'dash.previewHelp': '미리보기 영역: 카드를 드래그해 이동하고 오른쪽 아래 핸들로 크기를 조절하세요.',
    'dash.resetLayout': '그리드 레이아웃 초기화',
    'dash.preview': '미리보기',
    'dash.save': '대시보드 저장',
    'dash.saveCopy': '내 계정으로 복사 저장',
    'dash.publicId': '공개 ID',
    'dash.copyShareLink': '공유 링크 복사',
    'dash.openByEmailOrId': '이메일 또는 ID로 열기',
    'dash.ownerPlaceholder': 'owner 이메일 또는 dash-xxxx',
    'dash.openDashboard': '대시보드 열기',
    'dash.urlAccess': 'URL 접속:',
    'dash.widgets.noMatch': '필터 조건에 맞는 위젯이 없습니다.',
    'dash.widgets.emptyTitle': '비어 있음',
    'dash.widgets.emptyBadge': '안내',
    'dash.widgets.emptyMain': '선택된 위젯이 없습니다',
    'dash.widgets.emptySub': '왼쪽 패널에서 위젯을 활성화하세요.',
    'dash.widget.resize': '크기 조절',
    'dash.widget.badgeLive': '실시간',
    'dash.widget.defaultTitle': '위젯',
    'dash.widget.defaultMain': '준비됨',
    'dash.widget.defaultSub': '왼쪽 패널에서 구성하세요',
    'dash.ownerFallback': 'Tesla 오너',
    'dash.toast.loginFailed': '로그인에 실패했습니다. OAuth 제공자 설정을 확인하세요.',
    'dash.toast.loginRequired': '대시보드를 저장하려면 로그인이 필요합니다.',
    'dash.toast.saved': '대시보드가 저장되었습니다.',
    'dash.toast.savedCopy': '내 계정으로 복사 저장되었습니다.',
    'dash.toast.saveFirst': '먼저 저장해서 공개 ID를 생성하세요.',
    'dash.toast.shareCopied': '공유 링크를 복사했습니다.',
    'dash.toast.layoutInvalid': '레이아웃에 중첩 또는 범위 초과 위젯이 있습니다.',
    'dash.externalWidgets': '외부 위젯',
    'dash.externalWidgetsSubtitle': 'URL로 위젯 매니페스트를 추가하세요.',
    'dash.externalWidgetPlaceholder': 'https://example.com/widget-manifest.json',
    'dash.addExternalWidget': '외부 위젯 추가',
    'dash.toast.externalAdded': '외부 위젯이 등록되었습니다.',
    'dash.toast.externalFailed': '외부 위젯 추가에 실패했습니다.',
    'dash.toast.externalDisabled': '외부 위젯 기능은 현재 비활성화되어 있습니다.',
    'dash.inspector': '위젯 인스펙터',
    'dash.inspectorEmpty': '미리보기 또는 카탈로그에서 위젯을 선택해 설정하세요.',
    'dash.inspectorWidget': '위젯',
    'dash.sizeVariant': '크기',
    'dash.size.small': '작게',
    'dash.size.medium': '보통',
    'dash.size.large': '크게',
    'dash.customTitle': '제목',
    'dash.customTitlePlaceholder': '커스텀 제목 (선택)',
    'dash.weather.locationMode': '날씨 위치',
    'dash.weather.locationAuto': '현재 위치 사용',
    'dash.weather.locationManual': '위치 직접 선택',
    'dash.weather.searchPlaceholder': '도시 검색...',
    'dash.weather.searchHint': '검색 후 도시를 선택하세요.',
    'dash.weather.noResults': '검색 결과가 없습니다.',
    'dash.distanceUnit': '거리 단위',
    'dash.tempUnit': '온도 단위',
    'dash.timeFormat': '시간 형식',
    'dash.removeWidget': '위젯 제거',
  ...
  ja: {
    ...
    // Dashboard
    'dash.back': '← 戻る',
    'dash.title': 'My Tesla ダッシュボード',
    'dash.auth.signedOut': 'サインインしていません',
    'dash.auth.login': 'ログイン',
    'dash.auth.google': 'Google',
    'dash.auth.kakao': 'Kakao',
    'dash.auth.naver': 'Naver',
    'dash.auth.logout': 'ログアウト',
    'dash.customize': 'カスタマイズ',
    'dash.subtitle': 'Teslaディスプレイサイズを選択し、ウィジェットレイアウトを作成します。',
    'dash.vehicleModel': 'Tesla モデル / ディスプレイ',
    'dash.model.model3': 'Model 3',
    'dash.model.modely': 'Model Y',
    'dash.model.models': 'Model S',
    'dash.model.modelx': 'Model X',
    'dash.model.cybertruck': 'Cybertruck',
    'dash.display.default': '表示: 1920 x 1200',
    'dash.display.format': '表示: {width} x {height} ({model})',
    'dash.backgroundTheme': '背景テーマ',
    'dash.theme.teslaRed': 'Tesla Red',
    'dash.theme.midnight': 'Midnight Asphalt',
    'dash.theme.sunrise': 'Sunrise Drive',
    'dash.theme.emerald': 'Emerald Circuit',
    'dash.backgroundUrl': 'カスタム背景URL（任意）',
    'dash.backgroundUrlPlaceholder': 'https://...',
    'dash.widgets': 'ウィジェット',
    'dash.widgetsSubtitle': '好きなウィジェットを組み合わせてレイアウトを作成できます。',
    'dash.widget.preview': 'プレビュー',
    'dash.widget.add': '追加',
    'dash.widget.edit': '編集',
    'dash.widget.inspect': '表示',
    'dash.widgetSearchPlaceholder': 'ウィジェット名を検索...',
    'dash.filter.allCategories': 'すべてのカテゴリ',
    'dash.filter.allStyles': 'すべてのスタイル',
    'dash.previewHelp': 'プレビュー: カードをドラッグして移動し、右下ハンドルでサイズ変更します。',
    'dash.resetLayout': 'グリッドレイアウトをリセット',
    'dash.preview': 'プレビュー',
    'dash.save': 'ダッシュボードを保存',
    'dash.saveCopy': '自分用にコピー保存',
    'dash.publicId': '公開ID',
    'dash.copyShareLink': '共有リンクをコピー',
    'dash.openByEmailOrId': 'メールまたはIDで開く',
    'dash.ownerPlaceholder': 'owner メールまたは dash-xxxx',
    'dash.openDashboard': 'ダッシュボードを開く',
    'dash.urlAccess': 'URLアクセス:',
    'dash.widgets.noMatch': '条件に一致するウィジェットがありません。',
    'dash.widgets.emptyTitle': '空',
    'dash.widgets.emptyBadge': '情報',
    'dash.widgets.emptyMain': '選択されたウィジェットはありません',
    'dash.widgets.emptySub': '左パネルでウィジェットを有効にしてください。',
    'dash.widget.resize': 'サイズ変更',
    'dash.widget.badgeLive': 'ライブ',
    'dash.widget.defaultTitle': 'ウィジェット',
    'dash.widget.defaultMain': '準備完了',
    'dash.widget.defaultSub': '左パネルから設定してください',
    'dash.ownerFallback': 'Tesla オーナー',
    'dash.category.utility': 'ユーティリティ',
    'dash.category.social': 'ソーシャル',
    'dash.category.goal': '目標',
    'dash.category.vehicle': '車両',
    'dash.category.media': 'メディア',
    'dash.category.finance': '費用',
    'dash.category.navigation': 'ナビ',
    'dash.category.control': 'コントロール',
    'dash.category.health': 'ヘルス',
    'dash.category.performance': 'パフォーマンス',
    'dash.style.minimal': 'ミニマル',
    'dash.style.editorial': 'エディトリアル',
    'dash.style.vivid': 'ビビッド',
    'dash.style.neon': 'ネオン',
    'dash.style.card': 'カード',
    'dash.style.graph': 'グラフ',
    'dash.style.data': 'データ',
    'dash.style.tile': 'タイル',
    'dash.widget.clock': '時計',
    'dash.widget.greeting': 'あいさつ',
    'dash.widget.weekly': '週間チャレンジ',
    'dash.widget.badges': 'バッジ棚',
    'dash.widget.quickchat': 'クイックチャット',
    'dash.widget.battery': 'バッテリー',
    'dash.widget.range': '航続距離',
    'dash.widget.media': 'メディアショートカット',
    'dash.widget.weather': '天気',
    'dash.widget.calendar': 'カレンダー',
    'dash.widget.alerts': 'アラート',
    'dash.widget.energy': 'エネルギー効率',
    'dash.widget.cost': '月間コスト',
    'dash.widget.charging': '充電ETA',
    'dash.widget.tires': 'タイヤ空気圧',
    'dash.widget.navigation': '次のルート',
    'dash.widget.notes': 'ドライバーノート',
    'dash.widget.shortcut': 'ワンタップ操作',
    'dash.widget.quote': '今日の一言',
    'dash.widget.streamDeck': 'ストリームデッキ',
    'dash.widget.lifeTracker': 'ライフトラッカー',
    'dash.widget.weatherTiles': '天気タイル',
    'dash.widget.clockGrid': 'クロックグリッド',
    'dash.widget.sleepSuite': 'スリープスイート',
    'dash.widget.raceLap': 'レースラップ',
    'dash.widget.wavePulse': 'ウェーブパルス',
    'dash.widget.phoneStack': 'フォーンスタック',
    'dash.toast.loginFailed': 'ログインに失敗しました。OAuth設定を確認してください。',
    'dash.toast.loginRequired': 'ダッシュボード保存にはログインが必要です。',
    'dash.toast.saved': 'ダッシュボードを保存しました。',
    'dash.toast.savedCopy': '自分のアカウントにコピー保存しました。',
    'dash.toast.saveFirst': '先に保存して公開IDを生成してください。',
    'dash.toast.shareCopied': '共有リンクをコピーしました。',
    'dash.externalWidgets': '外部ウィジェット',
    'dash.externalWidgetsSubtitle': 'URLでウィジェットマニフェストを追加します。',
    'dash.addExternalWidget': '外部ウィジェットを追加',
    'dash.inspector': 'ウィジェットインスペクタ',
    'dash.inspectorEmpty': 'プレビューまたはカタログからウィジェットを選択して設定します。',
  },
  ...
  zh: {
    ...
    // Dashboard
    'dash.back': '← 返回',
    'dash.title': '我的 Tesla 仪表盘',
    'dash.auth.signedOut': '未登录',
    'dash.auth.login': '登录',
    'dash.auth.google': 'Google',
    'dash.auth.kakao': 'Kakao',
    'dash.auth.naver': 'Naver',
    'dash.auth.logout': '退出登录',
    'dash.customize': '自定义',
    'dash.subtitle': '选择Tesla显示尺寸并构建你的组件布局。',
    'dash.vehicleModel': 'Tesla 车型 / 显示屏',
    'dash.model.model3': 'Model 3',
    'dash.model.modely': 'Model Y',
    'dash.model.models': 'Model S',
    'dash.model.modelx': 'Model X',
    'dash.model.cybertruck': 'Cybertruck',
    'dash.display.default': '显示: 1920 x 1200',
    'dash.display.format': '显示: {width} x {height} ({model})',
    'dash.backgroundTheme': '背景主题',
    'dash.theme.teslaRed': 'Tesla Red',
    'dash.theme.midnight': 'Midnight Asphalt',
    'dash.theme.sunrise': 'Sunrise Drive',
    'dash.theme.emerald': 'Emerald Circuit',
    'dash.backgroundUrl': '自定义背景URL（可选）',
    'dash.backgroundUrlPlaceholder': 'https://...',
    'dash.widgets': '组件',
    'dash.widgetsSubtitle': '自由组合任意组件来打造你的布局。',
    'dash.widget.preview': '预览',
    'dash.widget.add': '添加',
    'dash.widget.edit': '编辑',
    'dash.widget.inspect': '查看',
    'dash.widgetSearchPlaceholder': '搜索组件名称...',
    'dash.filter.allCategories': '全部分类',
    'dash.filter.allStyles': '全部风格',
    'dash.previewHelp': '预览区: 拖动卡片移动，拖动右下角手柄调整大小。',
    'dash.resetLayout': '重置网格布局',
    'dash.preview': '预览',
    'dash.save': '保存仪表盘',
    'dash.saveCopy': '另存为我的副本',
    'dash.publicId': '公开ID',
    'dash.copyShareLink': '复制分享链接',
    'dash.openByEmailOrId': '通过邮箱或ID打开',
    'dash.ownerPlaceholder': 'owner 邮箱或 dash-xxxx',
    'dash.openDashboard': '打开仪表盘',
    'dash.urlAccess': 'URL 访问:',
    'dash.externalWidgets': '外部组件',
    'dash.externalWidgetsSubtitle': '通过 URL 添加组件清单。',
    'dash.addExternalWidget': '添加外部组件',
    'dash.inspector': '组件检查器',
    'dash.inspectorEmpty': '从预览或目录中选择组件进行配置。',
    'dash.widgets.noMatch': '没有匹配该筛选条件的组件。',
    'dash.widgets.emptyTitle': '空',
    'dash.widgets.emptyBadge': '信息',
    'dash.widgets.emptyMain': '未选择任何组件',
    'dash.widgets.emptySub': '请在左侧面板启用组件。',
    'dash.widget.resize': '调整大小',
    'dash.widget.badgeLive': '实时',
    'dash.widget.defaultTitle': '组件',
    'dash.widget.defaultMain': '就绪',
    'dash.widget.defaultSub': '请在左侧面板进行配置',
    'dash.ownerFallback': 'Tesla 车主',
    'dash.category.utility': '工具',
    'dash.category.social': '社交',
    'dash.category.goal': '目标',
    'dash.category.vehicle': '车辆',
    'dash.category.media': '媒体',
    'dash.category.finance': '费用',
    'dash.category.navigation': '导航',
    'dash.category.control': '控制',
    'dash.category.health': '健康',
    'dash.category.performance': '性能',
    'dash.style.minimal': '极简',
    'dash.style.editorial': '编辑风',
    'dash.style.vivid': '鲜明',
    'dash.style.neon': '霓虹',
    'dash.style.card': '卡片',
    'dash.style.graph': '图表',
    'dash.style.data': '数据',
    'dash.style.tile': '磁贴',
    'dash.widget.clock': '时钟',
    'dash.widget.greeting': '问候',
    'dash.widget.weekly': '每周挑战',
    'dash.widget.badges': '徽章架',
    'dash.widget.quickchat': '快捷聊天',
    'dash.widget.battery': '电池',
    'dash.widget.range': '续航',
    'dash.widget.media': '媒体快捷方式',
    'dash.widget.weather': '天气',
    'dash.widget.calendar': '日历',
    'dash.widget.alerts': '提醒',
    'dash.widget.energy': '能耗效率',
    'dash.widget.cost': '月度费用',
    'dash.widget.charging': '充电ETA',
    'dash.widget.tires': '胎压',
    'dash.widget.navigation': '下一路线',
    'dash.widget.notes': '驾驶笔记',
    'dash.widget.shortcut': '一键操作',
    'dash.widget.quote': '每日语录',
    'dash.widget.streamDeck': '直播面板',
    'dash.widget.lifeTracker': '生活追踪',
    'dash.widget.weatherTiles': '天气卡片',
    'dash.widget.clockGrid': '时钟网格',
    'dash.widget.sleepSuite': '睡眠套件',
    'dash.widget.raceLap': '竞速圈速',
    'dash.widget.wavePulse': '波形脉冲',
    'dash.widget.phoneStack': '手机堆栈',
    'dash.toast.loginFailed': '登录失败。请检查OAuth提供商配置。',
    'dash.toast.loginRequired': '保存仪表盘前请先登录。',
    'dash.toast.saved': '仪表盘已保存。',
    'dash.toast.savedCopy': '已复制并保存到你的账号。',
    'dash.toast.saveFirst': '请先保存以生成公开ID。',
    'dash.toast.shareCopied': '分享链接已复制。',
  }
};
