...
const TRANSLATIONS = {
  en: {
    ...
    'admin.kpiAvgSessionDuration': 'Avg Session Duration',
    'admin.kpiPeakConcurrentUsers': 'Peak Concurrent Users',
    'admin.kpiChatMessagesPerMin': 'Chat Msg / Min / User',
    'admin.kpiTrackedSessions': 'Tracked Sessions',
    ...
    'v2.auth.login': 'Log in',
    'v2.auth.gateTitle': 'Make Your Tesla More Special',
    'v2.auth.gateSubtitle': 'Sign in to unlock your Garage Badge Shelf and sync progress.',
    ...
    'v2.chat.title': 'Owners Chat',
    'v2.chat.subtitle': 'Talk with other Tesla owners in real time.',
    'v2.chat.urlPlaceholder': 'wss://your-worker.workers.dev/chat/global',
    'v2.chat.connect': 'Connect',
    'v2.chat.reconnect': 'Reconnect',
    'v2.chat.disconnected': 'Disconnected',
    'v2.chat.inputPlaceholder': 'Type a message...',
    'v2.chat.send': 'Send',
    ...
    'v2.chat.disconnectedNotice': 'Connection closed.',
    'v2.chat.error': 'Connection error',
    'v2.chat.connectFail': 'Failed to connect.',
    'v2.chat.sendWhileOffline': 'Connect chat first.',
    'v2.chat.sendFail': 'Failed to send message.',
  ...
  ko: {
    ...
    'admin.kpiAvgSessionDuration': '평균 체류 시간',
    'admin.kpiPeakConcurrentUsers': '최대 동시 접속자',
    'admin.kpiChatMessagesPerMin': '유저당 분당 채팅 수',
    'admin.kpiTrackedSessions': '추적 세션 수',
    ...
    'v2.auth.gateSubtitle': '로그인하면 Garage 배지 진열장을 열고 진행도를 동기화할 수 있습니다.',
    'v2.auth.logout': '로그아웃',
    ...
    'v2.chat.title': '오너 채팅',
    'v2.chat.subtitle': '테슬라 오너들과 실시간으로 대화하세요.',
    'v2.chat.urlPlaceholder': 'wss://your-worker.workers.dev/chat/global',
    'v2.chat.connect': '연결',
    'v2.chat.reconnect': '재연결',
    'v2.chat.disconnected': '연결 끊김',
    'v2.chat.inputPlaceholder': '메시지를 입력하세요...',
    'v2.chat.send': '전송',
    ...
    'v2.chat.disconnectedNotice': '연결이 종료되었습니다.',
    'v2.chat.error': '연결 오류',
    'v2.chat.connectFail': '연결에 실패했습니다.',
    'v2.chat.sendWhileOffline': '먼저 채팅을 연결하세요.',
    'v2.chat.sendFail': '메시지 전송에 실패했습니다.',
  ...
  ja: {
    ...
    'admin.kpiAvgSessionDuration': '平均セッション時間',
    'admin.kpiPeakConcurrentUsers': '最大同時接続ユーザー',
    'admin.kpiChatMessagesPerMin': 'ユーザー毎 分間チャット数',
    'admin.kpiTrackedSessions': '計測セッション数',
  ...
  zh: {
    ...
    'admin.kpiAvgSessionDuration': '平均会话时长',
    'admin.kpiPeakConcurrentUsers': '峰值并发用户',
    'admin.kpiChatMessagesPerMin': '每用户每分钟聊天数',
    'admin.kpiTrackedSessions': '已跟踪会话数',
